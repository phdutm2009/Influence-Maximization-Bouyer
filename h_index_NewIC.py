...
#Sort nodes
sorted_G_h_index = {k: v for k, v in sorted(G_h_index.items(), key=lambda item: item[1],reverse=True)}
...
top_50 = list(sorted_G_h_index)[:50]
top_50
